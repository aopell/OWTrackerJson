...
namespace OWTracker
{
    ...
    {
        internal static string SettingsPath { get; set; } = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + $"\\{Assembly.GetExecutingAssembly().GetCustomAttribute<AssemblyTitleAttribute>().Title}\\settings.json";
        ...
        public static void AddSetting(string setting, object value)
        {
            ...
            {
                MessageBox.Show($"Error loading or saving settings. Please file a bug report with the following information:\n\n{ex}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
